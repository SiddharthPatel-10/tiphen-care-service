        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
            <p className="text-base text-gray-600">
              "The lunch service provided by Tiphens is exceptional! Always on time and delicious."
            </p>
            <div className="mt-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
            <p className="text-base text-gray-600">
              "I love the convenience of ordering food through Tiphens. Quick and easy food service."
            </p>
            <div className="mt-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
            <p className="text-base text-gray-600">
              "Tiphens has made meal planning so much simpler with their variety of services."
            </p>
            <div className="mt-4">
